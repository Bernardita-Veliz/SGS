	...
	<div class="card card-outline card-success">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary" href="./index.php?page=funcionario_nuevo"><i class="fa fa-plus"></i> Agregar Nuevo funcionario</a>
			</div>
		</div>
		<div class="card-body">
...
<script>
	...
	$('.view_employee').click(function(){
		uni_modal("<i class='fa fa-id-card'></i> Detalles de funcionario","view_employee.php?id="+$(this).attr('data-id'))
	})
	$('.delete_employee').click(function(){
	_conf("¿Estás seguro de eliminar a este funcionario?","delete_employee",[$(this).attr('data-id')])
	})
	})
